...
PROMPT = """
你是时政历史文档分析专家，从文本中提取知识三元组。

【任务】提取所有与时政、历史、政治相关的信息。过滤日常琐事。

【分类 dimension】
history / politics / ideology / sensitive / military / diplomacy / economy_policy / society

【输出格式】JSON数组，每个元素:
{"head": "主体", "relation": "关系", "tail": "客体", "dimension": "分类", "detail": "细节"}
